...
const routes: Routes = [
  ...
  {path:'straLead', component:StrategieLeadershipComponent},
  ...
  {path:'list-exp', component: ExpertListComponent},
  {path:'create-exp', component:ExpertCreateComponent},
  {path:'detail-exp', component: ExpertDetailComponent},
  {path:'edit-exp', component:ExpertEditComponent},
  {path:'delete-exp', component: ExpertDeleteComponent},
